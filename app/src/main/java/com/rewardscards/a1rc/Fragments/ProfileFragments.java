...
public class ProfileFragments extends Fragment {
    ...
    androidx.constraintlayout.widget.ConstraintLayout card_about,card_faq,card_terms,card_privacy;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        card_about = (androidx.constraintlayout.widget.ConstraintLayout)view.findViewById(R.id.card_about);
        card_faq = (androidx.constraintlayout.widget.ConstraintLayout)view.findViewById(R.id.card_faq);
        card_terms = (androidx.constraintlayout.widget.ConstraintLayout)view.findViewById(R.id.card_terms);
        card_privacy = (androidx.constraintlayout.widget.ConstraintLayout)view.findViewById(R.id.card_privacy);
