...
public class AboutUsFragment extends Fragment {
    CardView card_about,card_faq,card_terms,card_privacy;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.about_us_fragment, null);
        card_about = (CardView)view.findViewById(R.id.card_about);
        card_faq = (CardView)view.findViewById(R.id.card_faq);
        card_terms = (CardView)view.findViewById(R.id.card_terms);
